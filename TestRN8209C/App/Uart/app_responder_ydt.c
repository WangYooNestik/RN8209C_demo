...
static EN_CID2_RTN Parse_Responder_Cmd(void)
{
	...
	u16 Idx1 = 0;
	u16 Idx2 = 0;
	EN_RN8209_CLB_GAIN_TYPE TempGainType;
	EN_RN8209_CLB_OFFSET_TYPE TempOffsetType;
	...
	switch(UartRcv.Data.Temp1.pBuf[YDT_IDX_CID2])
	{
		...
		case CID2_RCV_CALIBRATE_GAIN:
			...
			break;
		case CID2_RCV_CALIBRATE_OFFSET:
		...
		case CID2_RCV_GET_ANALOG:
			Float_To_DataBuf(System.Voltage,   &UartRcv.Data.Temp2.pBuf[Idx2], &Idx2, 4, 3);
			Float_To_DataBuf(System.Current_A, &UartRcv.Data.Temp2.pBuf[Idx2], &Idx2, 4, 3);
			Float_To_DataBuf(System.Power_A,   &UartRcv.Data.Temp2.pBuf[Idx2], &Idx2, 4, 3);
			Float_To_DataBuf(System.Energy_A,  &UartRcv.Data.Temp2.pBuf[Idx2], &Idx2, 4, 3);
			Float_To_DataBuf(System.Current_B, &UartRcv.Data.Temp2.pBuf[Idx2], &Idx2, 4, 3);
			Float_To_DataBuf(System.Power_B,   &UartRcv.Data.Temp2.pBuf[Idx2], &Idx2, 4, 3);
			Float_To_DataBuf(System.Energy_B,  &UartRcv.Data.Temp2.pBuf[Idx2], &Idx2, 4, 3);
			break;
