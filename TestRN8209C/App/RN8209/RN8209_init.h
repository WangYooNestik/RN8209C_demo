...
typedef enum{
	U_ADC_GAIN_1 = 1,		//RN8209内部 adc 放大器，1倍增益，不增益
	U_ADC_GAIN_2,			//RN8209内部 adc 放大器，2倍增益
	U_ADC_GAIN_4 = 4,		//RN8209内部 adc 放大器，4倍增益
}EN_U_ADC_GAIN;				//电压通道增益

#define U_ADC_GAIN U_ADC_GAIN_4

typedef enum{
	IA_ADC_GAIN_1 = 1,		//RN8209内部 adc 放大器，1倍增益，不增益
	IA_ADC_GAIN_2,			//RN8209内部 adc 放大器，2倍增益
	IA_ADC_GAIN_8 = 8,		//RN8209内部 adc 放大器，8倍增益
	IA_ADC_GAIN_16 = 16,	//RN8209内部 adc 放大器，16倍增益
