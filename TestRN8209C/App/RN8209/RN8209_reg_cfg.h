...
typedef enum{
	...
	SF_SLC_CH_B = 0xa5,
	SF_RESET = 0xfa,
}EN_RN8209_SF;//Special Function

#define IF_RN8209_SF_OK(SpecialFunc) if(!(SpecialFunc == SF_UNLOCK \
										|| SpecialFunc == SF_LOCK \
